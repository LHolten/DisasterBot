...
from rlbot.utils.game_state_util import GameState, Physics, Rotator, Vector3, CarState, BallState
...
def make_default_playlist():
    match_config = make_match_config_with_bots(blue_bots=[current_path / "shoot_at_goal_agent.cfg"])
