...
@vectorize([c16(c16, c16, c16)], nopython=True, fastmath=True)
def sc_fma(x, y, z):
    return (x * y + z)


@vectorize([c16(f8, f8, f8, f8, c16)], nopython=True, fastmath=True)
...
@vectorize([c16(c16)], nopython=True, fastmath=True)
